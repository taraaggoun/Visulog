...
/**
 * Plugin qui renvoie la contribution de chaque auteur pour les lignes (ajoutées et supprimées)
 */
public class ContributionLines implements AnalyzerPlugin {
    //Attributs
    ...
    //Constructeur
    /**
     * Construit un object de type ContributionLines
     * @param generalConfiguration
     */
    public ContributionLines(Configuration generalConfiguration) {
    ...
    */
    ...
    static class  Result implements AnalyzerPlugin.Result {
        ...
        public String getResultAsHtmlDiv() {
            ...
            "title:{\n text: \"Contribution lignes ajoutes par auteur\"\n,},\n"+
            "data : [{\n"+
            "type: \"pie\", startAngle: 25,indexLabelFontSize: 17,indexLabel: \"{label} - #percent%\",toolTipContent: \"<b {label}:</b> {y} (#percent%)\",\n dataPoints: [" );
            StringBuilder html_body1 = new StringBuilder("");
    
            StringBuilder html_head2 = new StringBuilder(
            "var chart2 = new CanvasJS.Chart(\"chartContainer2\", {\n animationEnabled: true,\n" +
            "title:{\n text: \"Contribution lignes supprimes par auteur\"\n,},\n"+
            "data : [{\n"+
            "type: \"pie\", startAngle: 25,indexLabelFontSize: 17,indexLabel: \"{label} - #percent%\",toolTipContent: \"<b {label}:</b> {y} (#percent%)\",\n dataPoints: [" );
            ...
            for(var item : Deleted.entrySet() ){
                html_head2.append("{ label : \"").append(item.getKey()).append("\", y : ").append(item.getValue()).append(" },\n");
            } 
            html_head1.append("]\n" + "}]\n" + "});\n" + " chart1.render();\n" + "\n" );
            html_body1.append("<div id=\"chartContainer1\" style=\"height: 480px; width: 100%;\"></div>\n" +
                "<script src=\"https://canvasjs.com/assets/script/canvasjs.min.js\"></script>");
    
            html_head2.append("\n" + "]\n" + "}]\n" + "});\n" + " chart2.render();\n" + "\n" + " }\n" +  "</script>");
            html_body2.append("<div id=\"chartContainer2\" style=\"height: 370px; width: 100%;\"></div>\n" +
                "<script src=\"https://canvasjs.com/assets/script/canvasjs.min.js\"></script>");
            return html_head1.toString() + html_head2.toString() + html_body1.toString() + html_body2.toString();
        }
    }
}